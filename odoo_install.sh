...
#--------------------------------------------------
echo -e "\n---- Install PostgreSQL Server ----"
sudo apt-get install -y gnupg gnupg1 gnupg2 curl
...
sudo apt-get install git build-essential python3-pip python3-dev python3-pillow python3-lxml python3-venv python3-wheel \
