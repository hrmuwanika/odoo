...
sudo apt-get install git python3 python3-pip build-essential wget python3-dev python3-venv python3-wheel libxslt-dev \
libzip-dev libldap2-dev libsasl2-dev python3-setuptools node-less python3-lxml libpng12-0 gdebi -y
