...
sudo apt-get install git python3-pip build-essential wget python3-dev python3-venv python3-lxml python3-wheel libxslt-dev libzip-dev \
libldap2-dev libsasl2-dev python3-setuptools node-less -y
